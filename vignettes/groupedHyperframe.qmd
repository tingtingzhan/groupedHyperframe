...
The Appendix is generally organized in the way that

-   the Markdown document **Header 2**, e.g. @sec-appendix `.x`, is about the object `class`;
-   the Markdown document **Header 3**, e.g. @sec-appendix `.x.x`, is about the method dispatches.
