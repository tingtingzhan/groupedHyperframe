...
out = s |>
  Emark_(r = r, correction = 'none', mc.cores = 1L) |> # slow
  # Vmark_(r = r, correction = 'none', mc.cores = 1L) |> # slow
  # markcorr_(r = r, correction = 'none', mc.cores = 1L) |> # slow
  # markvario_(r = r, correction = 'none', mc.cores = 1L) |> # slow
  Gcross_(i = 'CK+.CD8-', j = 'CK-.CD8+', r = r, correction = 'none', mc.cores = 1L) |> # fast
  # Kcross_(i = 'CK+.CD8-', j = 'CK-.CD8+', r = r, correction = 'none', mc.cores = 1L) |> # fast
  nncross_(i = 'CK+.CD8-', j = 'CK-.CD8+', correction = 'none', mc.cores = 1L) # fast
```
