...
c(
  ...
  '[`save`](https://search.r-project.org/R/refmans/base/html/save.html), `xz`', 'Save with [`xz`](https://en.wikipedia.org/wiki/XZ_Utils) compression', 
  ...
  '`trapz`, `cumtrapz`', '(Cumulative) [trapezoidal integration](https://en.wikipedia.org/wiki/Trapezoidal_rule), `pracma::trapz`; `pracma::cumtrapz`'
) |>
