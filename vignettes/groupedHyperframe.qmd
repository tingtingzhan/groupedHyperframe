...
It is important to note that several `S3` method dispatches to `hyperframe` class behave *very differently* from their counterpart in vanilla R, see Appendix @sec-hyperframe. Users are strongly advised to read the documentation of these functions from package **`spatstat.geom`**.
...
| `Imports`, `Enhances` | [*Writing R Extensions*, Section 1.1.3 *Package Dependencies*](https://cran.r-project.org/doc/manuals/r-devel/R-exts.html#Package-Dependencies) |
