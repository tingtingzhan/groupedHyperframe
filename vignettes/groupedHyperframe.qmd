...
Several `S3` method dispatches to `hyperframe` class behave *very differently* from their counterpart in vanilla R. Users are strongly advised to read the documentation of these functions from package **`spatstat.geom`**.
