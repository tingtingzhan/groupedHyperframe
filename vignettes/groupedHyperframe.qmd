...
-   `0`, from $0/x$, where $x$ is a positive `double`-precision scalar $\geq$ (approximately) `2.6e-324`
-   `NaN`, from $0/\varepsilon$, where $\varepsilon$ is a positive `double`-precision scalar $\leq$ (approximately) `2.5e-324`
-   `Inf`, from $x/0$, where $x$ is a positive `double`-precision scalar $\geq$ (approximately) `2.6e-324`
