...
Function `as.fvlist()` inspects a `listof` `fv.object`s and convert it to an object of class `'fvlist'`, before `spatstat.geom::hyperframe()` (ever) recognizes the class `'fvlist'`.
