...
The `S3` method dispatch `pairwise_cor_spatial.ppp()` finds the Tjostheim's correlation coefficient from the pairwise-combination of all `numeric` `marks` from the input `ppp.object`.
